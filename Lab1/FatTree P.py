...
class FatTree(Topo):
    def build(self):
        ...
        AcsSwitch12 = self.addSwitch('AcS12')
        AcsSwitch21 = self.addSwitch('AcS21')
        AcsSwitch22 = self.addSwitch('AcS22')
        AcsSwitch31 = self.addSwitch('AcS31')
        AcsSwitch11 = self.addSwitch('AcS11')
        AcsSwitch32 = self.addSwitch('AcS32')
        AcsSwitch41 = self.addSwitch('AcS41')
        AcsSwitch42 = self.addSwitch('AcS42')
